...
class OnBoardingScreen extends StatelessWidget {
            ...
            Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              TextButton(
                ...
                child: Text(
                  ...
                  style: poppinsSemiBold.copyWith(color: Theme.of(context).hintColor.withValues(alpha: 0.6)),
                ),
              ),
            ]),
  ...
  List<Widget> _pageIndicators(List<OnBoardingModel> onBoardingList, BuildContext context) {
