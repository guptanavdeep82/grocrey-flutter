...
class OrderRepo {
  ...
  Future<ApiResponseModel> paymentMobile({required PlaceOrderModel placeOrderModel}) async {
    try {
      final response = await dioClient!.post(AppConstants.placeDigitalOrder, data: placeOrderModel.toJson());
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponseModel> createRazorpayOrder({required double amount, required String currency, required String paymentRequestId}) async {
    try {
      final response = await dioClient!.post(AppConstants.razorpayCreateOrder, data: {
  ...
  Future<ApiResponseModel> verifyRazorpayPayment(Map<String, dynamic> data) async {
    try {
      final response = await dioClient!.post(AppConstants.razorpayVerifyPayment, data: data);
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
