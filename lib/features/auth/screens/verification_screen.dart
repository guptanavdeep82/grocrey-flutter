...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isFirebaseOTP = AuthHelper.isFirebaseVerificationEnable(config);
    ...
    return Scaffold(
      ...
      appBar:
          (ResponsiveHelper.isDesktop(context)
                  ...
                  : CustomAppBarWidget(title: getTranslated('otp_verification', context)))
              as PreferredSizeWidget?,
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            SliverToBoxAdapter(child: SizedBox(height: !ResponsiveHelper.isMobile() ? size.height * 0.04 : 0)),
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: Text(
                                '${getTranslated('we_have_sent_verification_code', context)} ${widget.userInput.substring(0, 6)}****${widget.userInput.substring(widget.userInput.length - 3)}',
                                textAlign: TextAlign.center,
                                style: poppinsRegular.copyWith(color: Theme.of(context).hintColor.withValues(alpha: 0.6)),
                              ),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: PinCodeTextField(
                              ...
                              pinTheme: PinTheme(
                                ...
                                inactiveColor: Theme.of(context).primaryColor.withValues(alpha: .2),
                                activeColor: Theme.of(context).primaryColor.withValues(alpha: .4),
                            ...
                            builder: (context, authProvider, _) {
                              ...
                              return Column(
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: poppinsMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: .6)),
                                      ),
                                      const SizedBox(width: Dimensions.paddingSizeSmall),

                                      verificationProvider.resendLoadingStatus
                                          ? CustomLoaderWidget(color: Theme.of(context).primaryColor)
                                          : TextButton(
                                              onPressed: verificationProvider.currentTime! > 0
                                                  ? null
                                                  : () async {
                                                      if (widget.fromPage != FromPage.forget.name) {
                                                        ...
                                                        if (isNumber && isFirebaseOTP) {
                                                          verificationProvider.firebaseVerifyPhoneNumber(
                                                            context,
                                                            userInput,
                                                            widget.fromPage,
                                                          ...
                                                          await authProvider
                                                              .forgetPassword(
                                                                userInput,
                                                                isNumber ? VerificationType.phone.name : VerificationType.email.name,
                                                              )
                                                              .then((value) {
                                                                verificationProvider.startVerifyTimer();
                                                                if (value.isSuccess) {
                                  ...
                                  (verificationProvider.isEnableVerificationCode && !verificationProvider.resendLoadingStatus)
                                      ? Padding(
                                                    ...
                                                    verificationProvider.verifyPhoneForOtp(userInput).then((value) {
                                                      ...
                                                      if ((responseModel != null && responseModel.isSuccess) && tempToken == null) {
                                                        ...
                                                        Navigator.pushReplacementNamed(
                                                          Get.context!,
                                                          RouteHelper.getOtpRegistration(tempToken, userInput),
                                                        );
                                                      }
                                                    });
                                                  }
