...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if( (configModel.forgetPassword?.phone == 1 || configModel.forgetPassword?.firebase == 1 )
              ...
              return Column(children: [
                ...
                Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    (forgotPasswordMethod == "both") ? Selector<AuthProvider, bool>(
                    ...
                    SizedBox(
                      ...
                      onPressed: () {
                        ...
                        if(_emailOrPhoneController.text.isEmpty && forgotPasswordMethod == "both"){
                          showCustomSnackBarHelper(getTranslated('enter_email_or_phone', context));
                        } else if(_emailOrPhoneController.text.isEmpty && forgotPasswordMethod == "email"){
                          showCustomSnackBarHelper(getTranslated('enter_email_address', context));
                        }
                        else if(_emailOrPhoneController.text.isNotEmpty && forgotPasswordMethod == "email" && EmailCheckerHelper.isNotValid(_emailOrPhoneController.text)){
                          showCustomSnackBarHelper(getTranslated('enter_valid_email', context));
                        }else if(isNumber && !isNumberValid && ( forgotPasswordMethod == "both" ||  forgotPasswordMethod == "phone")){
