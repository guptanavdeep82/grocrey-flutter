...
class CouponWidget extends StatelessWidget {
  const CouponWidget({super.key, required this.couponController, required this.discountedPrice});
                ...
                onTap: () {
                  if (couponController.text.isNotEmpty && !couponProvider.isLoading) {
                    if (couponProvider.discount! < 1) {
                      couponProvider.applyCoupon(couponController.text, discountedPrice);
                    } else {
