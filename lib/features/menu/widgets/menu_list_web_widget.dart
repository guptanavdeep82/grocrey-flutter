...
class MenuListWebWidget extends StatelessWidget {
  ...
  const MenuListWebWidget({super.key, required this.isLoggedIn});
  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      ...
      MenuModel(icon: Images.trackOrder, title: getTranslated('order_track', context), route: RouteHelper.orderSearchScreen),
      ...
      MenuModel(icon: Images.customerSupport, title: getTranslated('live_chat', context), route: RouteHelper.getChatRoute(
        orderId: "",
        profileImage:  "",
        userName: "",
        senderType: "admin"
      ...
      MenuModel(icon: Images.referralIcon, title: getTranslated('refund_policy', context), route: RouteHelper.getRefundPolicyRoute()),
                    ...
                    if(isLoggedIn) Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: poppinsRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
                        ),
                      ],
                    ),
