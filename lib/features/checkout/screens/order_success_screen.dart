                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    if(widget.status == 0 && widget.orderID != 'null') Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('${getTranslated('order_id', context)}:  #${widget.orderID}',
                          style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6))),
                    ]),
                    ...
                    if(widget.status == 0) SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: CustomButtonWidget(
                            buttonText: getTranslated('order_track', context),
                            onPressed: () {
