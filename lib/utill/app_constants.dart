import 'package:flutter_grocery/common/enums/local_caches_type_enum.dart';
import 'package:flutter_grocery/common/models/language_model.dart';
import 'images.dart';

class AppConstants {
  static const String appName = 'SAB Grocery';
  static const double appVersion = 7.8; /// Flutter Sdk : 3.35.4
  static const LocalCachesTypeEnum cachesType = LocalCachesTypeEnum.all;
  static const String fontFamily = 'Poppins';
  static const String baseUrl = 'https://admin.sabgrocery.in';
  static const String webHostUrl = 'https://sabgrocery.in';
  static const String googleServerClientId = '999232748999-9i487pfga5srcm7or38ogkhuoqfc0he0.apps.googleusercontent.com';
  static const String razorpayCreateOrder = '/api/v1/customer/razorpay/create-order';
  static const String razorpayVerifyPayment = '/api/v1/customer/razorpay/verify-payment';
  ...
  static const String storeOfflineData = '/api/v1/customer/order/store-offline-data';
  static const String switchPaymentMethod = '/api/v1/customer/order/switch-payment-method';
  static const String digitalPaymentResponse = '/api/v1/customer/order/switch-digital-payment-response';
  ...
  static const String lastIncompleteOfflineBookingId = 'last_incomplete_offline_order_id';
