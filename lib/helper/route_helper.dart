...
import 'package:flutter_grocery/features/splash/screens/safety_screen.dart';
...
class RouteHelper {
  ...
  static String trackMapScreen = '/track-map';
  ...
  static String getOtpRegistration(String? tempToken, String userInput, {String? userName}) {
    ...
    return '$otpRegistration?tempToken=$data&input=$input&userName=$name';
  }

  static String getSplashRoute() => splash;

  static String getOrderDetailsRoute(String? id, {String? phoneNumber, String? token}) =>
  ...
  static String getTrackMapScreen({OrderModel? order, int? orderId, int? deliverymanId}) {
    String data = base64Url.encode(utf8.encode(jsonEncode(order?.toJson())));
    return "$trackMapScreen?data=$data&deliveryman=$deliverymanId&order=$orderId";
  }
  ...
  static String getProductImagesRoute(String? name, String images, String baseUrl) =>
  ...
  static String getSafetyRoute() => safety;
  ...
  static String getChatRoute({
    ...
    return '$chatScreen?order_id=$orderId&name=$userName&image=$profileImage&type=$senderType&show_appbar=$isAppBar';
  }
  ...
  static final Handler _orderDetailsHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child: orderDetailsScreen ?? OrderDetailsScreen(orderId: orderId, orderModel: null, phoneNumber: phone, token: token, flag: flag),
      );
    },
  );

  static final Handler _onBoardingHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: OnBoardingScreen()),
  );
  ...
  static final Handler _loginHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const LoginScreen()),
  );

  static final Handler _forgetPassHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const ForgotPasswordScreen()),
  );
  ...
  static final Handler _createAccountHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const CreateAccountScreen()),
  );
  ...
  static final Handler _resetPassHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child: createPassScreen ?? CreateNewPasswordScreen(userInput: Uri.decodeComponent(params['email'][0]), resetToken: params['token'][0]),
      );
    },
  );
  ...
  static final Handler _updateAddressHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child:
            addNewAddressScreen ??
            AddNewAddressScreen(isEnableUpdate: true, fromCheckout: false, address: AddressModel.fromJson(jsonDecode(decoded))),
      );
    },
  );

  static final Handler _selectLocationHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      SelectLocationScreen? locationScreen = ModalRoute.of(context!)!.settings.arguments as SelectLocationScreen?;
      return _routeHandler(child: locationScreen ?? AddressListScreen());
    },
  );
  ...
  static final Handler _orderSuccessHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      int status = (params['status'][0] == 'success' || params['status'][0] == 'payment-success')
          ? 0
          : (params['status'][0] == 'fail' || params['status'][0] == 'payment-fail')
          ? 1
          : 2;
      return _routeHandler(
  ...
  static final Handler _paymentHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      debugPrint("---------------------${Uri.decodeComponent(utf8.decode(base64Decode(params['uri'][0])))}");
      return _routeHandler(
        child: PaymentScreen(orderId: int.tryParse(params['id'][0]), url: Uri.decodeComponent(utf8.decode(base64Decode(params['uri'][0])))),
      );
    },
  );
  ...
  static final Handler _notificationHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const NotificationScreen()),
  );
  ...
  static final Handler _trackOrderHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child: trackOrderScreen ?? TrackOrderScreen(orderID: params['id'][0], phone: Uri.decodeComponent(params['phone'][0])),
      );
    },
  );

  static final Handler _trackMapScreenHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      OrderModel? order;
      String decoded = utf8.decode(base64Url.decode(params['data'][0].replaceAll(' ', '+')));
      order = OrderModel.fromJson(jsonDecode(decoded));

      return _routeHandler(
        child: TrackMapScreen(orderId: int.tryParse(params['order'][0]), deliverymanId: int.tryParse(params['deliveryman'][0]), order: order),
      );
    },
  );
  ...
  static final Handler _categoryProductsHandlerNew = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return _routeHandler(
        child: CategoryProductScreen(categoryId: params['category_id'][0], subCategoryName: params['subcategory'][0]),
      );
    },
  );
  ...
  static final Handler _productDetailsHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child: ProductDetailsScreen(productId: params['product_id'][0], fromSearch: fromSearch),
      );
    },
  );
  ...
  static final Handler _profileHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const ProfileScreen()),
  );

  static final Handler _searchProductHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const SearchScreen()),
  );
  ...
  static final Handler _cartHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const CartScreen()),
  );
  ...
  static final Handler _profileMenusHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const MenuWidget()),
  );
  static final Handler _orderListScreenHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const OrderListScreen()),
  );
  static final Handler _addressHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const AddressListScreen()),
  );
  static final Handler _couponHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const CouponScreen()),
  );
  static final Handler _chatHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      bool isAppbar = params['show_appbar'][0] == 'true';
      return _routeHandler(
        child: ChatScreen(
          orderId: params['order_id'][0],
          userName: params['name'][0],
          senderType: params['type'][0],
          profileImage: params['image'][0],
          isAppBar: isAppbar,
        ),
      );
    },
  ...
  static final Handler _settingsHandler = Handler(
    handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const SettingsScreen()),
  );
  static final Handler _termsHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const HtmlViewerScreen(htmlType: HtmlType.termsAndCondition)),
  );

  static final Handler _policyHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const HtmlViewerScreen(htmlType: HtmlType.privacyPolicy)),
  );

  static final Handler _aboutUsHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const HtmlViewerScreen(htmlType: HtmlType.aboutUs)),
  );
  static final Handler _faqHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const HtmlViewerScreen(htmlType: HtmlType.faq)),
  );

  static final Handler _homeItemHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      return _routeHandler(child: HomeItemScreen(productType: params['item'][0]));
    },
  );
  static final Handler _maintenanceHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const MaintenanceScreen()),
  );
  static final Handler _safetyHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => const SafetyScreen());
  ...
  static final Handler _newAddressHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      ...
      return _routeHandler(
        child: AddNewAddressScreen(fromCheckout: params['page'][0] == 'checkout', isEnableUpdate: isUpdate, address: isUpdate ? addressModel : null),
      );
    },
  );

  static final Handler _otpRegistrationHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      return _routeHandler(
  ...
  static final Handler _favoriteHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const WishListScreen()),
  );

  static final Handler _walletHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
      child: WalletScreen(token: params['token'][0], status: params['flag'][0]),
    ),
  );

  static final Handler _referAndEarnHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const ReferAndEarnScreen()),
  );
  ...
  static final Handler _notFoundHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const HomeScreen()));
  static final Handler _loyaltyHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(child: const LoyaltyScreen()));
  ...
  static void setupRouter() {
    ...
    router.define(trackMapScreen, handler: _trackMapScreenHandler, transitionType: TransitionType.fadeIn);
    ...
    router.define(safety, handler: _safetyHandler, transitionType: TransitionType.fadeIn);
  ...
  static Widget _routeHandler({required Widget child}) {
    return isMaintenance(Provider.of<SplashProvider>(Get.context!, listen: false).configModel) ? const MaintenanceScreen() : child;
  }
