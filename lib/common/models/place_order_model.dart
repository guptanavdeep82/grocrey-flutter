...
class PlaceOrderModel {
  ...
  PlaceOrderModel copyWith({String? paymentMethod, String? transactionReference, String? callBack, String? orderId, String? shwitchToDigital}) {
    if(paymentMethod != null) _paymentMethod = paymentMethod;
    if(transactionReference != null) _transactionReference = transactionReference;
    if(callBack != null) _callBack = callBack;
    if(orderId != null) _orderId = orderId;
    if(shwitchToDigital != null) _switchOfflineToDigital = shwitchToDigital;
    return this;
  }
  ...
  String? get shwitchToDigital => _switchOfflineToDigital;
