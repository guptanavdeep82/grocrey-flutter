...
class NotificationDialogWebWidget extends StatefulWidget {
  ...
  const NotificationDialogWebWidget({super.key, required this.title, required this.body, required this.orderId, this.image, this.type, this.userName, this.senderType, this.profileImage});
                    ...
                    try{
                      if(widget.orderId == null) {
                        Navigator.pushNamed(context, RouteHelper.getChatRoute(
                          ...
                          senderType: widget.senderType ?? "admin"
                        ));
