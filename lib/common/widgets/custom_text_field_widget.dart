      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            style: Theme.of(
              context,
            ).textTheme.displayMedium!.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeLarge),
              ...
              prefixIcon: widget.isShowPrefixIcon
                  ? IconButton(
                      ...
                      icon: widget.prefixAssetUrl != null
                          ? Image.asset(widget.prefixAssetUrl!, color: widget.prefixAssetImageColor ?? Theme.of(context).primaryColor, scale: 2.5)
                          : Icon(widget.prefixIconUrl, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
                      onPressed: () {},
                    )
              ...
              suffixIcon: widget.isShowSuffixIcon
                  ? widget.isPassword
                        ...
                        ? Tooltip(
                            ...
                            child: IconButton(
                              onPressed: widget.onSuffixTap as void Function()?,
                              icon: CustomAssetImageWidget(widget.suffixAssetUrl!, width: 20, height: 20),
                            ),
                          )
